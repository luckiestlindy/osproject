...
from booker.choices import INSTRUMENT_TYPES, EVENT_TYPES, WEDDING_OPTIONS, OUTDOOR_CHOICES, BOOKING_STATUS
...
class Musician(models.Model):
    ...
    image = VersatileImageField(
        'Image', upload_to='images/musicians/', width_field='width', height_field='height', ppoi_field='ppoi'
        )
...
class Ensemble(models.Model):
    ...
    photo = VersatileImageField(
        'Image', upload_to='images/ensembles/', width_field='width', height_field='height', ppoi_field='ppoi'
        )
    width = models.PositiveIntegerField('Image Width', blank=True, null=True)
    height = models.PositiveIntegerField('Image Height', blank=True, null=True)
    ppoi = PPOIField('Image PPOI')
...
class Event(models.Model):
    ...
    ensemble_type = models.ForeignKey(Ensemble, blank=True, null=True,on_delete=models.DO_NOTHING)
    ...
    musician_one = models.ForeignKey(Musician, blank=True, null=True, related_name='musician_one',on_delete=models.DO_NOTHING)
    musician_two = models.ForeignKey(Musician, blank=True, null=True, related_name='musician_two',on_delete=models.DO_NOTHING)
    musician_three = models.ForeignKey(Musician, blank=True, null=True, related_name='musician_three',on_delete=models.DO_NOTHING)
    musician_four = models.ForeignKey(Musician, blank=True, null=True, related_name='musician_four',on_delete=models.DO_NOTHING)
    musician_five = models.ForeignKey(Musician, blank=True, null=True, related_name='musician_five',on_delete=models.DO_NOTHING)
    ...
    prelude_one = models.ForeignKey(Selection, blank=True, null=True, related_name='prelude_one',on_delete=models.DO_NOTHING)
    prelude_two = models.ForeignKey(Selection, blank=True, null=True, related_name='prelude_two',on_delete=models.DO_NOTHING)
    prelude_three = models.ForeignKey(Selection, blank=True, null=True, related_name='prelude_three',on_delete=models.DO_NOTHING)
    prelude_four = models.ForeignKey(Selection, blank=True, null=True, related_name='prelude_four',on_delete=models.DO_NOTHING)
    prelude_five = models.ForeignKey(Selection, blank=True, null=True, related_name='prelude_five',on_delete=models.DO_NOTHING)
    processional = models.ForeignKey(Selection, blank=True, null=True, related_name='processional',on_delete=models.DO_NOTHING)
